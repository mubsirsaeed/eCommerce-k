...
<!-- Mirrored from www.bootstrapdash.com/demo/skydash/template/demo/vertical-default-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Dec 2022 14:16:55 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              ...
              <li class="nav-item"><a class="nav-link" href="Add_product.php">Product</a></li>                
                <li class="nav-item"><a class="nav-link" href="employement_form.php">Employee Form</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="product.php">Product List</a></li>
                <li class="nav-item"> <a class="nav-link" href="employee_table.php">Employee Table</a></li>
                <li class="nav-item"> <a class="nav-link" href="order_table.php">Order Table</a></li>
              </ul>
            </div>
          </li>
