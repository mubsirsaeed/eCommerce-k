                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" class="cmxform">
                      <div class="form-group">
                        ...
                        <input id="firstname" class="form-control" name="emp_name" type="text" value ="<?php echo $row['u_name']?>">
                      </div>
                      <div class="form-group">
                        <label for="email">Email</label>
                        <input id="email" class="form-control" name="email" type="email" value ="<?php echo $row['u_email']?>">
                      </div>
                      <div class="form-group">
                        <label for="password">Password</label>
                        <input id="password" class="form-control" name="password" type="password" value ="<?php echo $row['u_password']?>">
                      </div>
                      <div class="form-group">
                        <label for="confirm_password">Confirm password</label>
                        <input id="confirm_password" class="form-control" name="conpassword" type="password" value ="<?php echo $row['u_conpassword']?>">
                      </div>
                    ...
                    <?php
                      if(isset($_POST['btn']))
                      {
                          ...
                          $sql = "UPDATE `users` SET `u_name`='$empname',`u_email`='$email',`u_password`='$password',`u_conpassword`='$conpassword' WHERE u_id = '$emp_id'";                          
